            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Buy a new ticket</h1>
                    </div>
                    ...
                    <section id="first-tab-group" class="tabgroup">
                        <div id="tab1" style="display: block;">
                            <div class="submit-form">
                                <form id="form-submit" action="../order.php" method="post">
                                    <table>
                                        <body>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="date"  name="departure" id="deparure"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>        <label for="premium">Premium</label>
                                                        <input type="radio" name="class" id="premium" value="premium" required="required" onchange="this.form.()">
                                                        <label for="business">Business</label>
                                                        <input type="radio" name="class" id="business" value="business" required="required" onchange="this.form.()">
                                                      </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td><fieldset>
                                                <button type="submit" id="form-submit" class="btn btn-sm btn-danger">Order Ticket Now</button>
                                            </fieldset></td>
                                            </tr>
                                        </body>
                                    </table>
